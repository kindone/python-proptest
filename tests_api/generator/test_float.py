...
class TestFloatGenerator(unittest.TestCase):
    ...
    def test_float_partial_posinf_probability(self, value: float):
        ...
        self.assertTrue((math.isinf(value) and value > 0) or math.isfinite(value))
    ...
    @for_all(Gen.float(nan_prob=0.1, posinf_prob=0.1), num_runs=1000)
    ...
    def test_float_all_three_probabilities_together(self, value: float):
        ...
        self.assertTrue(math.isnan(value) or math.isinf(value) or math.isfinite(value))
