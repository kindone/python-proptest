...
class TestStringGenerator(unittest.TestCase):
    ...
    def test_printable_ascii_string_range(self, value: str):
        ...
        self.assertIsInstance(value, str)
        self.assertTrue(
            all(char in printable and 32 <= ord(char) <= 126 for char in value)
        )
    ...
    @for_all(
        Gen.string(min_length=2, max_length=5, charset=Gen.int(97, 122)), num_runs=200
    )
    ...
    @for_all(
        Gen.str(min_length=3, max_length=6, charset=Gen.integers(48, 10)), num_runs=200
    )
    ...
    @for_all(
        Gen.str(min_length=1, max_length=4, charset=Gen.int(48, 122)), num_runs=200
    )
