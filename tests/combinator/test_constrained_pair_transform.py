        ...
        for _ in range(10):
            ...
            def check_all_shrinks(sh, depth=0, max_depth=5):
                ...
                if sh.value[0] < 4 or sh.value[0] > 10:
                    problems.append((depth, sh.value, f"first {sh.value[0]} out of [4, 10]"))
                if sh.value[1] < 4 or sh.value[1] > 10:
                    problems.append((depth, sh.value, f"second {sh.value[1]} out of [4, 10]"))
                for child in sh.shrinks().to_list():
                    problems.extend(check_all_shrinks(child, depth+1, max_depth))
                return problems
        ...
        for _ in range(10):
            ...
            def check_all_shrinks(sh, depth=0, max_depth=5):
                ...
                if sh.value[0] < 8 or sh.value[0] > 20:
                    problems.append((depth, sh.value, f"first {sh.value[0]} out of [8, 20]"))
                if sh.value[1] < 8 or sh.value[1] > 20:
                    problems.append((depth, sh.value, f"second {sh.value[1]} out of [8, 20]"))
                for child in sh.shrinks().to_list():
                    problems.extend(check_all_shrinks(child, depth+1, max_depth))
                return problems
