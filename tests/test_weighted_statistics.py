...
class TestWeightedStatistics(unittest.TestCase):
    ...
    def _chi_square_test(self, observed: Dict[Any, int], expected: Dict[Any, float], 
    ...
    def _is_probability_close(self, actual: float, expected: float, 
    ...
    def test_chi_square_goodness_of_fit(self):
        ...
        self.assertLess(chi_square, 20.0, 
