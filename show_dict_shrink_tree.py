...
def visualize_shrink_tree(shrinkable, max_depth=3, indent=0, prefix="", max_children=10):
...
def main():
    ...
    print(f"Number of immediate shrink candidates: {len(shrinkable.shrinks().to_list())}")
    ...
    print(f"Number of immediate shrink candidates: {len(shrinkable2.shrinks().to_list())}")
