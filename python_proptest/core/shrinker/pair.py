...
def shrink_pair(
    ...
    def shrink_first(parent: Shrinkable[Tuple[Shrinkable[T], Shrinkable[U]]]) -> Stream[Shrinkable[Tuple[Shrinkable[T], Shrinkable[U]]]]:
        first_shr, second_shr = parent.value
        # Use flatMap on first_shr: for each shrink of first_shr, create a new pair
        def create_pair_with_shrunk_first(shrunken_first_val: T) -> Shrinkable[Tuple[Shrinkable[T], Shrinkable[U]]]:
    ...
    def shrink_second(parent: Shrinkable[Tuple[Shrinkable[T], Shrinkable[U]]]) -> Stream[Shrinkable[Tuple[Shrinkable[T], Shrinkable[U]]]]:
        first_shr, second_shr = parent.value
        # Use flatMap on second_shr: for each shrink of second_shr, create a new pair
        def create_pair_with_shrunk_second(shrunken_second_val: U) -> Shrinkable[Tuple[Shrinkable[T], Shrinkable[U]]]:
