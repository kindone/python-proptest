...
echo ""
echo "TestPyPI URL: https://test.pypi.org/project/python-proptest/"
echo ""
echo "To test the installation from TestPyPI:"
echo "  pip install --index-url https://test.pypi.org/simple/ python-proptest"
echo ""
echo "Or create a test script:"
echo "  python -c \"import python_proptest; print('Installation successful!')\""
echo ""
