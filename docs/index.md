...
- [`Gen.int(min_value, max_value)`](generators.md#genintmin_value-max_value) - Random integers
- [`Gen.float(min_value, max_value, nan_prob, posinf_prob, neginf_prob)`](generators.md#genfloatmin_value-max_value-nan_prob-posinf_prob-neginf_prob) - Random floats (finite by default, optional inf/NaN probabilities)
- [`Gen.bool(true_prob)`](generators.md#genbooltrue_prob) - Random booleans with configurable probability
- [`Gen.str(min_length, max_length, charset)`](generators.md#genstrmin_length-max_length-charset) - Random strings with customizable charset (default: lowercase letters, or use "ascii"/"printable_ascii", or a codepoint generator)
- [`Gen.ascii_string(min_length, max_length)`](generators.md#genascii_stringmin_length-max_length) - ASCII strings (0-127)
- [`Gen.printable_ascii_string(min_length, max_length)`](generators.md#genprintable_ascii_stringmin_length-max_length) - Printable ASCII strings (32-126)
- [`Gen.unicode_string(min_length, max_length)`](generators.md#genunicode_stringmin_length-max_length) - Unicode strings
- [`Gen.ascii_char()`](generators.md#genascii_char) - ASCII character codes (0-127)
- [`Gen.unicode_char()`](generators.md#genunicode_char) - Unicode character codes (avoiding surrogate pairs)
- [`Gen.printable_ascii_char()`](generators.md#genprintable_ascii_char) - Printable ASCII character codes (32-126)
- [`Gen.in_range(min_value, max_value)`](generators.md#genin_rangemin_value-max_value) - Integers in range [min, max) (exclusive)
- [`Gen.interval(min_value, max_value)`](generators.md#genintervalmin_value-max_value) - Integers in range [min, max] (inclusive)
- [`Gen.integers(start, count)`](generators.md#genintegersstart-count) - Integers in range [start, start+count) (count parameter)
- [`Gen.natural(max_value)`](generators.md#gennaturalmax_value) - Positive integers [1, max_value]
- [`Gen.non_negative(max_value)`](generators.md#gennon_negativemax_value) - Non-negative integers [0, max_value]

**Container Generators:**

- [`Gen.list(element_gen, min_length, max_length)`](generators.md#genlistelement_gen-min_length-max_length) - Lists
- [`Gen.unique_list(element_gen, min_length, max_length)`](generators.md#genunique_listelement_gen-min_length-max_length) - Lists with unique elements (sorted)
- [`Gen.set(element_gen, min_size, max_size)`](generators.md#gensetelement_gen-min_size-max_size) - Sets
- [`Gen.dict(key_gen, value_gen, min_size, max_size)`](generators.md#gendictkey_gen-value_gen-min_size-max_size) - Dictionaries
- [`Gen.tuple(*generators)`](generators.md#gentuplegenerators) - Fixed-size tuples

**Special Generators:**

- [`Gen.just(value)`](generators.md#genjustvalue) - Always generates the same value
- [`Gen.lazy(func)`](generators.md#genlazyfunc) - Defers evaluation until generation
- [`Gen.construct(Type, *generators)`](combinators.md#genconstructtype-generators) - Creates class instances

**Dependent Generation Combinators:**

- [`Gen.chain(base_gen, gen_factory)` / `generator.chain(gen_factory)`](combinators.md#genchainbase_gen-gen_factory-generatorchaingen_factory) - Creates dependent tuples
- [`Gen.aggregate(initial_gen, gen_factory, min_size, max_size)` / `generator.aggregate(...)`](combinators.md#genaggregateinitial_gen-gen_factory-min_size-max_size-generatoraggregate) - Generates list with dependent elements
- [`Gen.accumulate(initial_gen, gen_factory, min_size, max_size)` / `generator.accumulate(...)`](combinators.md#genaccumulateinitial_gen-gen_factory-min_size-max_size-generatoraccumulate) - Generates final value after dependent steps

**Selection Combinators:**

- [`Gen.one_of(*generators)`](combinators.md#genone_ofgenerators) - Randomly chooses from multiple generators
- [`Gen.element_of(*values)`](combinators.md#genelement_ofvalues) - Randomly chooses from multiple values
- [`Gen.weighted_gen(generator, weight)`](combinators.md#genweighted_gengenerator-weight) - Wraps generator with weight for one_of
- [`Gen.weighted_value(value, weight)`](combinators.md#genweighted_valuevalue-weight) - Wraps value with weight for element_of

**Transformation Combinators:**

- [`generator.map(func)`](combinators.md#generatormapfunc) - Transforms generated values
- [`generator.filter(predicate)`](combinators.md#generatorfilterpredicate) - Filters values by predicate
- [`generator.flat_map(func)`](combinators.md#generatorflat_mapfunc) - Creates dependent generators

**Decorators:**

- [`@for_all(*generators, num_runs, seed)`](decorators.md#for_all) - Core property-based testing decorator
- [`@run_for_all(*generators, num_runs, seed)`](decorators.md#run_for_all) - Versatile decorator for complex generators (chain, aggregate, accumulate)
- [`@example(*values)`](decorators.md#example) - Provides specific example values to test
- [`@settings(num_runs, seed)`](decorators.md#settings) - Configures test parameters
- [`@matrix(**kwargs)`](decorators.md#matrix) - Provides exhaustive Cartesian product testing
