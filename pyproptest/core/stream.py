...
class Stream(Generic[T]):
    ...
    def __init__(self, head: Optional[T] = None, tail: Optional[Callable[[], 'Stream[T]']] = None):
        self._head = head
        self._tail = tail
    ...
    def three(cls, value1: T, value2: T, value3: T) -> 'Stream[T]':
        ...
        return cls(head=value1, tail=lambda: cls(head=value2, tail=lambda: cls(head=value3)))
