...
def for_all(*generators: Generator[Any], num_runs: int = 100, seed: Union[str, int, None] = None):
    """
        ...
        def wrapper(*args, **kwargs):
            ...
            if is_pytest_method:
                ...
                try:
                    ...
                    property_test = Property(pytest_property, num_runs=num_runs, seed=seed)
                ...
                try:
                    ...
                    property_test = Property(assertion_property, num_runs=num_runs, seed=seed)
                    property_test.for_all(*actual_generators)
                    return None  # Pytest expects test functions to return None
                except PropertyTestError as e:
...
def dictionaries(keys: Strategy, values: Strategy, min_size: int = 0, max_size: int = None) -> Strategy:
